...
/* ********************************************************************* */
void Init (double *v, double r, double x2, double x3)
/*! 
 ...
 *********************************************************************** */
{
  ...
  double P = P_SURF * exp(BETA * (PLANET_RADIUS / (UNIT_LENGTH * r)  - 1));
  if (P < 1e-9) {
 ...
 *********************************************************************** */
{
  double g_unitAccel = UNIT_VELOCITY * UNIT_VELOCITY / UNIT_LENGTH;
  double a = SEMIMAJOR_AXIS;
  double l_cm = a / (1 + PLANET_MASS/STAR_MASS);
  double r = x1 * UNIT_LENGTH;
  double accel = -CONST_G * PLANET_MASS / (r * r) + CONST_G * STAR_MASS / ((a-r) * (a-r)) - CONST_G * (STAR_MASS + PLANET_MASS) / (a * a * a) * (l_cm - r);
